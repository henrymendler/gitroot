...
* Lines are buffered so that the can be output to        *
...
*                                                        *
* Parameters                                             *
*      name -- Name of disk file to use input.           *
*                                                        *
* Returns                                                *
*      0 -- Open succeeded.                              *
*      nonzero -- Open failed.                           *
...
*      next character.                                   *
**********************************************************/
exturn int in_next_char(void);

/*********************************************************
* in_flush -- Flushes the buffered input line to the     *
*              screen.                                   *
**********************************************************/
exturn void in_flush(void);
